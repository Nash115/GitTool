...
fetch_container.pack(anchor="n",side="left", padx=5)
...
status_list.pack()
status_list_container.pack(anchor="n",side="left", padx=5)
...
commit_container.pack(anchor="n",side="left", padx=5)
...
push_container.pack(anchor="n",side="left", padx=5)
